...
string Dialogue::getRandomNegativeAdmirerResponse(){
    int index = rand() % negativeAdmirerResponse.size();
    return negativeAdmirerResponse[index].line;
}

string Dialogue::getRandomPositiveAdmirerResponse(){
    int index = rand() % positiveAdmirerResponse.size();
    return positiveAdmirerResponse[index].line;
}
