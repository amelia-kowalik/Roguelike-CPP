...
void Character::displayStats() {
    ...
    cout << "EGO: " << _ego << endl;
    cout << "TRAITS: " << endl;
    cout << "MANIPULATION [" << Trait[MANIPULATION] << "]" << endl;
    cout << "CHARM [" << Trait[CHARM] << "]" << endl;
    cout << "INTELLIGENCE [" << Trait[INTELLIGENCE] << "]" << endl;
    cout << "CHARISMA [" << Trait[CHARISMA] << "]" << endl;
    cout << endl;
}

void Character::addPoints(){
    cout << "You have " << _ego << " point(s) to spend! Choose the trait you want to make stronger: " << endl;
    cout << "1. MANIPULATION [" << Trait[MANIPULATION] << "]" << endl;
    cout << "2. CHARM [" << Trait[CHARM] << "]" << endl;
    cout << "3. INTELLIGENCE [" << Trait[INTELLIGENCE] << "]" << endl;
    cout << "4. CHARISMA [" << Trait[CHARISMA] << "]" << endl;
