...
- **EGO** - ogólna statystyka, każda wygrana Emmy sprawia, że level upuje swoje EGO. Wzmacnia reszte statystyk.

- **ŚMIAŁOŚĆ** - emma mówi szybciej niż wielbiciel

- **MANIPULACJA** - pomaga wygrać słowne potyczki 

- **UROK** - pomaga przykuć uwagę wielbiciela i zapobiec jej straceniu

- **CHARYZMA** - pomaga uniknąć niekomfortowych tematów, o których wspomina wielbiciel

- **INTELIGENCJA** - pomaga zaimponować wielbicielowi
...
- perfumy (+3 punkty do MANIPULACJI) **VERY RARE**

- wachlarz (+2 punkt do ŚMIAŁOŚCI) **RARE**

- rękawiczki (+2 punkty do UROKU) **COMMON**

- szal (+3 punkt do UROKU) **UNCOMMON**

- róż (+1 punkt do ŚMIAŁOŚCI) **UNCOMMON**

- chusteczka (+1 do UROKU) **COMMON**

- herbata z hibiskusa (+1 punkt SZANSY) **EPIC**

- książka Frances Burney (+2 punkt do INTELIGENCJI) **RARE**
...
- Emma rozpoczyna grę bez żadnych punktów EGO, reszta statystyk ma 1 punkt
...
- Emma i przeciwnik posiadają **111 punktów życia**. Potyczka słowna trwa do czasu aż jedno z nich będzie miało zycie<=0

- Kolor przeciwnika na mapie pokazuje jaka cecha jest jego słabością (np. różowy oznacza UROK)
